...
def layout() -> html.Div:
    ...
    return html.Div([
        ...
        dbc.Row([
            dbc.Col(
                build_chart_container("tab3-residuals-time", "Residuals Over Time", height="280px"),
                md=4,
            ),
            dbc.Col(
                build_chart_container("tab3-residuals-hist", "Residual Distribution", height="280px"),
                md=4,
            ),
            dbc.Col(
                build_chart_container("tab3-residuals-pred", "Residuals vs Predicted", height="280px"),
                md=4,
            ),
        ], className="g-2 mt-1"),
        ...
        dbc.Row([
            dbc.Col(
                build_chart_container("tab3-error-heatmap", "Forecast Error by Hour of Day", height="300px"),
                md=6,
            ),
            dbc.Col(
                build_chart_container("tab3-shap", "SHAP Feature Importance (XGBoost)", height="300px"),
                md=6,
            ),
        ], className="g-2 mt-1"),
    ])
