        ...
        dbc.Row([
            dbc.Col([
                dbc.Checklist(
                    ...
                    options=[{"label": " Weather Overlay (Temperature)", "value": "temp"}],
                    value=[],
                    inline=True,
                    className="mt-1",
            ...
            dbc.Col([
                html.Label("Time Range:", className="fw-bold me-2", style={"fontSize": "0.85rem"}),
                dbc.RadioItems(
                    id="tab1-timerange",
                    options=[
                        {"label": "24h", "value": "24"},
        ...
        dbc.Row([
            dbc.Col([
                html.Div([
                    ...
                    html.H4(id="tab1-peak-value", children="— MW", className="kpi-value"),
                    html.P(id="tab1-peak-time", children="", className="kpi-delta neutral"),
                ], className="kpi-card"),
            ], md=6),
            dbc.Col([
                html.Div([
                    html.P("AVERAGE DEMAND", className="kpi-label"),
                    html.H4(id="tab1-mape-value", children="— MW", className="kpi-value"),
