...
def _build_drivers_panel(weather_json: str | None) -> list:
    ...
    drivers = [
        ...
        },
        {
            ...
            "unit": "mph",
            "color": tokens.WEATHER_DRIVERS["wind"],
            "fillcolor": tokens.alpha(tokens.WEATHER_DRIVERS["wind"], 0.10),
            "fmt": lambda v: f"{v:.1f}",
        },
        {
            "label": "Solar",
            ...
            "unit": "W/m²",
            "color": tokens.WEATHER_DRIVERS["solar"],
            "fillcolor": tokens.alpha(tokens.WEATHER_DRIVERS["solar"], 0.10),
            "fmt": lambda v: f"{v:.0f}",
        },
    ]
