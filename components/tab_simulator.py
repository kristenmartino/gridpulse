    ...
    return html.Div([
        dbc.Row([
            ...
            dbc.Col([
                # Weather sliders
                html.Div([
                    html.H6("Weather Scenario Builder", style={"color": "#ffffff", "marginBottom": "12px"}),
                    ...
                    _slider("Solar Irradiance (W/m²)", "sim-solar", 0, 1000, 500, 25, "W/m²"),
                    ...
                    dbc.Row([
                        dbc.Col(
                            dbc.Button("▶ Run Scenario", id="sim-run-btn", color="danger", size="sm", className="w-100"),
                            md=6,
                        ),
                        dbc.Col(
                            dbc.Button("↺ Reset", id="sim-reset-btn", outline=True, color="secondary", size="sm", className="w-100"),
                            md=6,
                        ),
                    ], className="g-2"),
                ...
                # Preset scenarios
                html.Div([
                    html.H6("Preset Historical Scenarios", style={"color": "#ffffff", "marginBottom": "10px"}),
                    html.Div([
            ...
            ], md=3, style={"maxHeight": "85vh", "overflowY": "auto"}),
                ...
                dbc.Row([
                    dbc.Col([
                        html.Div([
                            ...
                            html.H4(id="sim-demand-delta", children="— MW", className="kpi-value"),
                            html.P(id="sim-demand-delta-pct", className="kpi-delta neutral"),
                        ], className="kpi-card"),
                    ], md=3),
                    dbc.Col([
                        html.Div([
                            html.P("PRICE IMPACT", className="kpi-label"),
                            html.H4(id="sim-price-impact", children="— $/MWh", className="kpi-value"),
                            html.P(id="sim-price-delta", className="kpi-delta neutral"),
                        ], className="kpi-card"),
                    ], md=3),
                    dbc.Col([
                        html.Div([
                            html.P("RESERVE MARGIN", className="kpi-label"),
                            html.H4(id="sim-reserve-margin", children="— %", className="kpi-value"),
                            html.P(id="sim-reserve-status", className="kpi-delta neutral"),
                        ], className="kpi-card"),
                    ], md=3),
                    dbc.Col([
                        html.Div([
                            html.P("RENEWABLE IMPACT", className="kpi-label"),
                            html.H4(id="sim-renewable-impact", children="—", className="kpi-value"),
                            html.P(id="sim-renewable-detail", className="kpi-delta neutral"),
                        ], className="kpi-card"),
                    ], md=3),
                ], className="g-2 mb-2"),

                # Main comparison chart
                build_chart_container("sim-forecast-chart", "Baseline vs Scenario Forecast", height="340px"),

                # Bottom row: price curve + renewable breakdown
                dbc.Row([
                    dbc.Col(
                        build_chart_container("sim-price-chart", "Price Impact Curve", height="280px"),
                        md=6,
                    ),
                    dbc.Col(
                        build_chart_container("sim-renewable-chart", "Renewable Generation Impact", height="280px"),
                        md=6,
                    ),
                ], className="g-2 mt-1"),
...
def _slider(
    ...
    return html.Div([
        html.Div([
            ...
            html.Span(f"{default}{unit}", id=f"{slider_id}-display", className="slider-value",
                       style={"float": "right"}),
        ]),
        dcc.Slider(
            id=slider_id,
