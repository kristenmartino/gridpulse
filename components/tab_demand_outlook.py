...
def layout() -> html.Div:
    ...
    return html.Div([
        ...
        dbc.Row([
            dbc.Col([
                html.Div([
                    html.Span("Forecast as of: ", style={"fontSize": "0.9rem", "color": "#666"}),
                    html.Span(id="outlook-data-through", children="—",
        ...
        dbc.Row([
            dbc.Col([
                html.Div([
                    ...
                    html.H4(id="outlook-peak", children="— MW", className="kpi-value"),
                    html.P(id="outlook-peak-time", children="", className="kpi-delta neutral"),
                ], className="kpi-card"),
            ], md=3),
            dbc.Col([
                html.Div([
                    html.P("AVERAGE DEMAND", className="kpi-label"),
                    html.H4(id="outlook-avg", children="— MW", className="kpi-value"),
            ...
            dbc.Col([
                html.Div([
                    ...
                    html.H4(id="outlook-min", children="— MW", className="kpi-value"),
                    html.P(id="outlook-min-time", children="", className="kpi-delta neutral"),
                ], className="kpi-card"),
            ], md=3),
            dbc.Col([
                html.Div([
                    html.P("DEMAND RANGE", className="kpi-label"),
                    html.H4(id="outlook-range", children="— MW", className="kpi-value"),
