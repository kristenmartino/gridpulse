...
def generate_demo_alerts(region: str = "FPL") -> list[dict]:
    ...
    if region in ("ERCOT", "SPP"):
        alerts.append({
            ...
            "event": "Wind Advisory",
            "headline": f"Wind Advisory: gusts up to 45 mph",
...
def _get_fuel_shares(region: str) -> dict[str, float]:
    ...
    shares = {
        "ERCOT": {"gas": 0.40, "wind": 0.25, "solar": 0.10, "coal": 0.10, "nuclear": 0.10, "hydro": 0.02, "other": 0.03},
        "CAISO": {"gas": 0.35, "solar": 0.25, "wind": 0.10, "hydro": 0.10, "nuclear": 0.08, "coal": 0.02, "other": 0.10},
        "PJM":   {"gas": 0.35, "nuclear": 0.30, "coal": 0.15, "wind": 0.08, "solar": 0.05, "hydro": 0.03, "other": 0.04},
        "MISO":  {"gas": 0.30, "wind": 0.20, "coal": 0.20, "nuclear": 0.15, "solar": 0.05, "hydro": 0.05, "other": 0.05},
        "NYISO": {"gas": 0.35, "nuclear": 0.25, "hydro": 0.20, "wind": 0.08, "solar": 0.05, "coal": 0.02, "other": 0.05},
        "FPL":   {"gas": 0.55, "nuclear": 0.20, "solar": 0.12, "coal": 0.03, "wind": 0.02, "hydro": 0.01, "other": 0.07},
        "SPP":   {"wind": 0.35, "gas": 0.30, "coal": 0.20, "solar": 0.05, "nuclear": 0.05, "hydro": 0.03, "other": 0.02},
        "ISONE": {"gas": 0.45, "nuclear": 0.25, "hydro": 0.08, "wind": 0.08, "solar": 0.05, "coal": 0.02, "other": 0.07},
    }
