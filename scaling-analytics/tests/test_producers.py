...
class TestWeatherProducer:
    ...
    def test_produces_to_correct_topic(self, mock_fetch, mock_producer, small_weather_df):
    ...
    @patch("src.ingestion.weather_producer.Producer")
    @patch("src.ingestion.weather_producer.fetch_weather")
    def test_message_key_is_region(self, mock_fetch, mock_producer, small_weather_df):
    ...
    @patch("src.ingestion.weather_producer.Producer")
    @patch("src.ingestion.weather_producer.fetch_weather")
    def test_message_value_is_valid_json(self, mock_fetch, mock_producer, small_weather_df):
...
class TestGridProducer:
    ...
    def test_produces_to_correct_topic(self, mock_fetch, mock_producer, small_demand_df):
    ...
    @patch("src.ingestion.grid_producer.Producer")
    @patch("src.ingestion.grid_producer.fetch_demand")
    def test_message_has_demand_fields(self, mock_fetch, mock_producer, small_demand_df):
