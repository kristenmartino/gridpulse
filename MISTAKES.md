...
- 2026-08-18 [worklog-concurrent-deposit] Two sessions depositing at the same time collided: PR #566 and PR #567 both inserted at the top of this list and produced a merge conflict in this file, twice during one rebase. The resolution is trivial (keep both) but every concurrent deposit hits it. — ref: PR #567
