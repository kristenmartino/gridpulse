...
[#542](https://github.com/kristenmartino/gridpulse/issues/542) leaves
`lead_hours` null on ~79% of records so it cannot be reconstructed. Filed as a
follow-up; the doc states the limit as unmeasured rather than as small.
