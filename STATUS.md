...
*(Re-verified 2026-08-05 against `gh issue list`: all three slots are still
open and still correctly ordered. Deltas since — #275 is down to **20 of 23**
items (`ledger-8`/`-9`/`-11` cleared by [#396](https://github.com/kristenmartino/gridpulse/pull/396) +
[#398](https://github.com/kristenmartino/gridpulse/pull/398)); new
[#399](https://github.com/kristenmartino/gridpulse/issues/399) (test pyramid
inverted, no e2e coverage on US Grid) is **deliberately not** promoted into
this block — it is invisible to users, and slot 1 is user-visible wrong
numbers. The 2026-08-04 incident ([#389](https://github.com/kristenmartino/gridpulse/issues/389))
remains the active focus above this block, ahead of all three.)*
