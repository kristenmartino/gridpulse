...
PERSONAS: dict[str, Persona] = {
    "grid_ops": Persona(
        ...
        priority_tabs=["tab-forecast", "tab-outlook", "tab-backtest"],
        kpi_metrics=[
            "peak_demand_mw",
            "reserve_margin_pct",
            "active_alerts_count",
    ...
    "renewables": Persona(
        ...
        priority_tabs=["tab-outlook", "tab-forecast", "tab-backtest"],
        kpi_metrics=[
    ...
    "data_scientist": Persona(
        ...
        priority_tabs=["tab-backtest", "tab-outlook", "tab-forecast"],
        kpi_metrics=[
            "ensemble_mape_pct",
            "model_drift_score",
