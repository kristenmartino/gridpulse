...
3. **STAR-story trigger hit** (trade-off, debugging arc, surprising
   ...
   → draft the story in [`docs/INTERVIEW_PREP.md`](docs/INTERVIEW_PREP.md)
   in same PR
...
*(Note: HOW_IT_WORKS.md and INTERVIEW_PREP.md currently exist as stubs;
real content lands in PR-C1 / PR-C2. The end-of-PR check is still
operational against the stubs — update the relevant TODO sections or
add new candidates to the STAR-story list as appropriate.)*
